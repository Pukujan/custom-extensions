...
- validation: existing collection tests plus responsive desktop/tablet/mobile screenshots and PDF packet rendered locally; canonical README remains unchanged
