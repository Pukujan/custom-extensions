...
No further live action is required for the accepted v0.1 pilot/holdout baseline. Keep the optional PROV-0006 live observer unrun until explicitly authorized; run official-import validation only if the user supplies a ZIP. Do not start account-wide export automatically.
